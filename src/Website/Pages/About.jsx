...
function About() {
    return (
        <>
        <Header/>
        <div id="about" className="parallax-window" data-parallax="scroll" data-image-src="website/img/antique-cafe-bg-03.jpg">
                ...
                <div className="tm-item-container sm:ml-auto sm:mr-12 mx-auto sm:px-0 px-4">
                    <div className="bg-white bg-opacity-80 p-12 pb-14 rounded-xl mb-5">
                        ...
                        <p className="text-base leading-8">
                            If you wish to <Link rel="nofollow" href="https://www.tooplate.com/contact" target="_parent">support us</Link>, please make a little donation via PayPal. That would be
                            very helpful. Another way is to tell your friends about Tooplate website. Thank you. </p>
                    </div>
                    <Link href="#contact" className="inline-block tm-bg-green transition text-white text-xl pt-3 pb-4 px-8 rounded-md">
