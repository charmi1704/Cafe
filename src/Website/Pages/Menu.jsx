...
function Menu() {
    return (
        <>
            <Header />
            <div id="menu" className="parallax-window" data-parallax="scroll" data-image-src="website/img/antique-cafe-bg-02.jpg">
                    ...
                    <div className="flex flex-col lg:flex-row justify-around items-center">
                        <div className="flex-1 m-5 rounded-xl px-4 py-6 sm:px-8 sm:py-10 tm-bg-brown tm-item-container">
                            <div className="flex items-start mb-6 tm-menu-item">
                                <img src="website/img/menu-item-1.jpg" alt="Image" className="rounded-md" />
                            ...
                            <div className="flex items-start mb-6 tm-menu-item">
                                <img src="website/img/menu-item-2.jpg" alt="Image" className="rounded-md" />
                                <div className="ml-3 sm:ml-6">
                            ...
                            <div className="flex items-start mb-6 tm-menu-item">
                                <img src="website/img/menu-item-3.jpg" alt="Image" className="rounded-md" />
                                <div className="ml-3 sm:ml-6">
                            ...
                            <div className="flex items-start mb-6 tm-menu-item">
                                <img src="website/img/menu-item-4.jpg" alt="Image" className="rounded-md" />
                                <div className="ml-3 sm:ml-6">
                        ...
                        <div className="flex-1 m-5 rounded-xl px-4 py-6 sm:px-8 sm:py-10 tm-bg-brown tm-item-container">
                            <div className="flex items-start justify-end mb-6 tm-menu-item-2">
                                ...
                                <img src="website/img/menu-item-5.jpg" alt="Image" className="rounded-md" />
                            </div>
                            <div className="flex items-start justify-end mb-6 tm-menu-item-2">
                                <div className="text-right mr-6">
                                ...
                                <img src="website/img/menu-item-6.jpg" alt="Image" className="rounded-md" />
                            </div>
                            <div className="flex items-start justify-end mb-6 tm-menu-item-2">
                                <div className="text-right mr-6">
                                ...
                                <img src="website/img/menu-item-7.jpg" alt="Image" className="rounded-md" />
                            </div>
                            <div className="flex items-start justify-end mb-6 tm-menu-item-2">
                                <div className="text-right mr-6">
                                ...
                                <img src="website/img/menu-item-8.jpg" alt="Image" className="rounded-md" />
                            </div>
                        </div>
                    </div>
                </div>
