...
function Contact() {
    return (
        <>
            <Header />
            <div id="contact" className="parallax-window relative" data-parallax="scroll" data-image-src="website/img/antique-cafe-bg-04.jpg">
                <div className="container mx-auto tm-container pt-24 pb-48 sm:py-48">
                    <div className="flex flex-col lg:flex-row justify-around items-center lg:items-stretch">
                        <div className="flex-1 rounded-xl px-10 py-12 m-5 bg-white bg-opacity-80 tm-item-container">
                            ...
                            <p className="mb-10 text-lg">
                                <span className="block mb-2">Tel: <Link to="tel:0100200340" className="hover:text-yellow-600 transition">010-020-0340</Link></span>
                                <span className="block">Email: <Link to="mailto:info@company.com" className="hover:text-yellow-600 transition">info@company.com</Link></span>
                            </p>
                            <div className="text-center">
                                <Link to="https://www.google.com/maps" className="inline-block text-white text-2xl pl-10 pr-12 py-6 rounded-lg transition tm-bg-green">
                    ...
                    <footer className="absolute bottom-0 left-0 w-full">
                        <div className="text-white container mx-auto tm-container p-8 text-lg flex flex-col md:flex-row justify-between">
                            ...
                            <span className="mt-5 md:mt-0">Design: <Link to="https://www.tooplate.com" target="_parent">Tooplate</Link></span>
                        </div>
                    </footer>
                </div>
            </div>
