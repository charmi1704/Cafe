...
function Intro() {
    return (
        <>
            <Header />
            <div id="intro" className="parallax-window" data-parallax="scroll" data-image-src="website/img/antique-cafe-bg-01.jpg">
                ...
                <div className="sm:pb-60 sm:pt-48 py-20">
                    ...
                    <div className="bg-black bg-opacity-70 p-10 mb-5">
                        <p className="text-white leading-8 text-sm font-light">
                            ...
                            If you have any question, please <Link rel="nofollow" href="https://www.tooplate.com/contact" target="_parent">send us a message</Link>. </p>
                    </div>
                    <div className="text-center">
                        <div className="inline-block">
                            <Link href="#menu" className="flex justify-center items-center bg-black bg-opacity-70 py-6 px-8 rounded-lg font-semibold tm-text-2xl tm-text-gold hover:text-gray-200 transition">
